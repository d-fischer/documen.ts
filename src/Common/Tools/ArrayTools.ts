export function partition<EntryType, TrueEntryType extends EntryType = EntryType>(arr: readonly EntryType[], predicate: (val: EntryType) => val is TrueEntryType): [EntryType[], TrueEntryType[]] {
